...
public class T2PreprocessingAutoChooser extends JApplet {
	...
	public T2PreprocessingAutoChooser(int numOfFiles, List<String> texts) {
	...
	public void init() {
		...
		btnNext.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Runtime.getRuntime().exec("java -jar T2PreprocessingManual.jar" + arguments);
		...
		btnSwitchView.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (ret == JOptionPane.OK_OPTION) {
					try {
						Runtime.getRuntime().exec("java -jar T2PreprocessingManual.jar");
					} catch (IOException e1) {
						e1.printStackTrace();
					}
					System.exit(0);
		...
		btnAddMoreFiles.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (numOfFiles < 4) {
					...
					applet = new T2PreprocessingAutoChooser(numOfFiles, texts);
					applet.init();
		...
		btnHelp.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				frame.setTitle("T2 Pre-processing(Auto) Help");
	...
	public static void main(String[] args) {
		f = new JFrame();
		applet = new T2PreprocessingAutoChooser();

		applet.init();

		f.setContentPane(applet.getContentPane());
		f.setBounds(920, 100, 510, 208);
		f.setTitle("T2 Pre-processing(Auto)");
		f.setVisible(true);
