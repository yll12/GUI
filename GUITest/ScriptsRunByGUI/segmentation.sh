...
fslmaths $sdir/$subj-grad.nii.gz -sub $sdir/$subj-MAD1.nii.gz -abs $sdir/$subj-MAD2.nii.gz
...
fslmaths segmentations/"$subj"_all_labels.nii.gz -uthr 82 segmentations/"$subj"_labels.nii.gz
